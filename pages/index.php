...
?>
            ...
            <div class="row">
                ...
                <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                <input type="text" placeholder="Digite para buscar um produto?">
                                <button type="submit" class="site-btn">BUSCAR</button>
                            </form>
                        </div>
                        <div class="hero__search__phone">
                            <div class="hero__search__phone__icon">
                            <a href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp_link ?> "target=”_blank” title="<?php echo $whatsapp ?>"><i class="fa fa-whatsapp text-success" alt="Logo do Whatsapp" ></i></a> 
                            </div>
                    ...
                    <div class="hero__item set-bg" data-setbg="../assets/img/hero/banner.jpg">
                        ...
                        <span><?php echo strToUpper($name_store) ?></span>
                        <h2>Produtos de<br />Primeira Linha</h2>
                        <p>Aqui você encontra os melhores preços!!</p>
                        <a href="../pages/products.php" class="primary-btn">COMPRAR AGORA</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="featured spad">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".womens_fashion">Moda Feminina</li>
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 womens_fashion fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../assets/img/product/product-1.jpg">
                        ...
                        <div class="featured__item__text">
                           <a href="product.php"><h6>Blusa Feminina</h6></a>
                            <h5>R$30.00</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix womens_fashion fastfood">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="../assets/img/product/product-2.jpg">
                            <ul class="featured__item__pic__hover">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="product.php">Blusa Feminina</a></h6>
                            <h5>R$50.00</h5>
                        </div>
                    </div>
                </div>
    ...
    <!-- Banner Begin (Editavel no photoshop) --> 
    <div class="banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
                    <img src="../assets/img/banner/banner-promo.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
                     <img src="../assets/img/banner/banner-promo-2.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
